# 농식품 유망기술 설명회 — 행사 홍보 페이지

한국농업기술진흥원(KOAT) 주관 **농식품 유망기술 설명회**(2026 범부처 공공기술 이전·사업화 로드쇼 부대행사) 홍보용 정적 페이지입니다.
치유농업·식량농업·스마트농업 분야 유망기술을 소개합니다.
빌드 도구 없이 단일 `index.html` 파일 하나로 동작하며, GitHub Pages에서 바로 배포할 수 있습니다.

- 일시 : 2026. 9. 14.(월) 14:00 ~ 16:00
- 장소 : ST 과학기술컨벤션센터
...
- **소개유망기술(Patents)** — 카드형 목록 + 분야별 필터(치유/식량/스마트농업)
